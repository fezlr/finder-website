# Finder Website
A dating platform where you can create a profile, browse real users, and match with people who liked you back. Features email verification, photo uploads, and a swipe-based interface.
